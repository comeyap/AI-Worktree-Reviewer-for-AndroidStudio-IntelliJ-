...
![Build](https://github.com/comeyap/Worktree-Reviewer-for-Android-Studio/actions/workflows/build-plugin.yml/badge.svg)
...
1. Download `aiworktreereviewer-*.zip` from the
   [Releases](https://github.com/comeyap/Worktree-Reviewer-for-Android-Studio/releases) page.
